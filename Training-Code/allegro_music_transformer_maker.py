# -*- coding: utf-8 -*-
"""Allegro_Music_Transformer_Maker.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1O3QjgfEQ_EN9utFU1te83BgwHuKj1ip8

# Allegro Music Transformer Maker (ver. 1.0)
...
for i in tqdm.tqdm(range(NUM_BATCHES), mininterval=10., desc='Training'):
    ...
    if i % SAVE_EVERY == 0:
        ...
        fname = '/home/ubuntu/model_checkpoint_' + str(i) + '_steps_' + str(round(float(train_losses[-1]), 4)) + '_loss_' + str(round(float(train_accs[-1]), 4)) + '_acc.pth'
