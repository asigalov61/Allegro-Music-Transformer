...
# Allegro Music Transformer Composer (ver. 2.0)
...
number_of_prime_tokens = 4992 # @param {type:"slider", min:128, max:5000, step:16}
...
number_of_tokens_to_generate = 303 # @param {type:"slider", min:33, max:1023, step:3}
number_of_batches_to_generate = 4 #@param {type:"slider", min:1, max:16, step:1}
preview_length_in_tokens = 120 # @param {type:"slider", min:33, max:240, step:3}
number_of_memory_tokens = 1018 # @param {type:"slider", min:402, max:2048, step:2}
