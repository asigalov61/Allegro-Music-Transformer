...
# Allegro Music Transformer (ver. 2.0)
...
number_of_tokens_tp_generate = 300 #@param {type:"slider", min:30, max:2046, step:30}
...
number_of_prime_tokens = 306 #@param {type:"slider", min:3, max:2046, step:3}
